...
double _jp_trigthr[_jp_ntrigger]        = {       30,         60,          80,        110,    
                                                 150,        190,         240,        370};
double _jp_trigranges[_jp_ntrigger][2]  = {{0,   97},  {97, 174},  {174, 174}, {174,  300},  
                                          {300, 300}, {300, 362},  {362, 507}, {507, 3500}};
...
// (significant speedup, but remember to enable the right branches!)
